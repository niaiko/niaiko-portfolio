                  ...
                  <div className="bg-white dark:bg-dark-card rounded-2xl p-6 border-2 border-gray-200 dark:border-dark-border hover:border-primary-500 dark:hover:border-primary-500 transition-all shadow-lg hover:shadow-2xl">
                    ...
                    <div className="flex flex-col items-center space-y-3">
                      <div className="relative">
                        <Icon className="text-5xl text-gray-700 dark:text-gray-300 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors" />
                        
                        {/* Glow Effect */}
                        <motion.div
                          className={`absolute inset-0 blur-xl opacity-0 group-hover:opacity-50 bg-gradient-to-br ${category.color} rounded-full`}
                          animate={{
                            scale: [1, 1.2, 1],
                          }}
                          transition={{
